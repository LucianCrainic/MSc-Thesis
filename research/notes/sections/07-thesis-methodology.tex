...
the same socket as the control.  This produces the three primary
research questions set out in \tabref{tab:research-questions}, each
with a prediction registered in advance:
...
\begin{description}
  ...
  \tabref{tab:platform-record}, identify HBM and DDR NUMA nodes, and
