...
\input{sections/01-sd650-v3-hardware.tex}
\input{sections/02-cresco8-cluster.tex}

\clearpage
\part{Workload model and research evidence}
\input{sections/03-paper-llm-inference-cpu.tex}
\input{sections/04-paper-aurora-hbm.tex}

\clearpage
\part{Experimental design}
\input{sections/05-thesis-methodology.tex}
