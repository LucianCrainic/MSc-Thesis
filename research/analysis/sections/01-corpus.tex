...
The four works occupy different evidential roles.
\tabref{tab:corpus-roles} prevents results from one role being used as
if they answered another.
...
comparison reproduced in \tabref{tab:stream-critical}:
